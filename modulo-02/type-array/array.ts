...
let idiomas: Array<string> = ['Português', 'Inglês', 'Francês', 'Espanhol'];
console.log(idiomas);
...
let idiomas1: Array<string> = ['Português', 'Inglês', 'Francês', 'Espanhol'];
...
let linguagensArray: string[] = new Array('Javascript', 'Python', 'PHP', 'C#', 'Typescript');
